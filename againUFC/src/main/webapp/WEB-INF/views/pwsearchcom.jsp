            ...
            <article>
               <form action = "Loginok.do" method = "post">
                  ...
                  <br>
                   ...
                   <br>
                   <tr>
                       <td colspan="2"><span><%= name %>님의 비밀번호는 <%= pw %>입니다.</span></td>
                   </tr>
                    <tr>
                        <td><input type = "button" value = "로그인"  id = "search1" onclick = "login()"></td><td><input type = "button" value = "메인페이지" id = "search2" onclick = "main()"></td>
                    </tr>
                  </table>
                </form>
            </article>
